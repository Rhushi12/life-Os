                ...
                <div className="bg-zinc-950/50 backdrop-blur-xl border border-zinc-800 rounded-3xl p-8 shadow-2xl">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            <input type="email" placeholder="Email address" className="w-full bg-zinc-900/50 border border-zinc-800 rounded-xl px-4 py-3 text-white placeholder:text-zinc-600 focus:border-[#5100fd] focus:ring-0 outline-none transition-all" />
