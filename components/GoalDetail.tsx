...
export default function GoalDetail({ plan, onNavigate, onActivate }: GoalDetailProps) {
        ...
        <div className="min-h-screen w-full bg-black pt-24 pb-20">
            ...
            <main className="container mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in">
                ...
                <div className="mt-12 flex justify-center gap-4">
                    ...
                    <button
                        onClick={onActivate}
                        className="px-8 py-3 rounded-full bg-[#5100fd] hover:bg-[#6610ff] text-white font-medium shadow-[0_0_30px_-10px_rgba(81,0,253,0.5)] transition-all hover:scale-105"
                    >
                        Activate Plan
                    </button>
                </div>
