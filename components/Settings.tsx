                ...
                <div className="space-y-8">
                    ...
                    <section className="bg-zinc-950 border border-zinc-800 rounded-2xl p-8">
                        ...
                        <div className="flex items-center gap-6 mb-6">
                            ...
                            <div>
                                <div className="text-white font-medium">Builder User</div>
                                <div className="text-zinc-500 text-sm">builder@example.com</div>
                            </div>
                        </div>
                            ...
                            <div className="flex items-center justify-between p-4 bg-zinc-900/50 rounded-xl border border-zinc-800/50">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-zinc-500 text-xs">Read-only access enabled</div>
                                    </div>
                                </div>
                                <button className="text-sm text-zinc-400 hover:text-white">Configure</button>
                            </div>
                        </div>
                    </section>
                    ...
                    {/* Data */}
                     ...
                     <div className="text-center pt-8">
                        <button onClick={() => onNavigate('landing')} className="text-red-500 hover:text-red-400 text-sm">Sign Out</button>
                     </div>
                </div>
            </main>
        </div>
